...
# Created by write_sdc on Wed Dec 27 15:32:36 2023

###################################################################
set sdc_version 2.0

set_units -time ns -resistance kOhm -capacitance pF -voltage V -current mA
set_load -pin_load 0 [get_ports mosi]
set_load -pin_load 0 [get_ports miso]
set_load -pin_load 0 [get_ports sck]
set_load -pin_load 0 [get_ports {ssn_o[7]}]
set_load -pin_load 0 [get_ports {ssn_o[6]}]
set_load -pin_load 0 [get_ports {ssn_o[5]}]
set_load -pin_load 0 [get_ports {ssn_o[4]}]
set_load -pin_load 0 [get_ports {ssn_o[3]}]
set_load -pin_load 0 [get_ports {ssn_o[2]}]
set_load -pin_load 0 [get_ports {ssn_o[1]}]
set_load -pin_load 0 [get_ports {ssn_o[0]}]
set_load -pin_load 0 [get_ports {data_o[7]}]
set_load -pin_load 0 [get_ports {data_o[6]}]
set_load -pin_load 0 [get_ports {data_o[5]}]
set_load -pin_load 0 [get_ports {data_o[4]}]
set_load -pin_load 0 [get_ports {data_o[3]}]
set_load -pin_load 0 [get_ports {data_o[2]}]
set_load -pin_load 0 [get_ports {data_o[1]}]
set_load -pin_load 0 [get_ports {data_o[0]}]
set_load -pin_load 0 [get_ports ack_o]
set_load -pin_load 0 [get_ports int_o]
set_load -pin_load 0 [get_ports rx_valid]
set_load -pin_load 0 [get_ports {rx_data[7]}]
set_load -pin_load 0 [get_ports {rx_data[6]}]
set_load -pin_load 0 [get_ports {rx_data[5]}]
set_load -pin_load 0 [get_ports {rx_data[4]}]
set_load -pin_load 0 [get_ports {rx_data[3]}]
set_load -pin_load 0 [get_ports {rx_data[2]}]
set_load -pin_load 0 [get_ports {rx_data[1]}]
set_load -pin_load 0 [get_ports {rx_data[0]}]
